...
def ex_extract_and_match_feature(img_1, img_2, ratio_robustness=0.7):
    ...
    2/ use a bruteforce search to find pairs of matched features: for each feature point in img_1, 
    find its best matched feature point in img_2
    ...
    :return list_pairs_matched_keypoints: has the format as list of pairs of matched points: 
    [[[p1x,p1y],[p2x,p2y]]]
    '''
    # ==============================
...
if __name__ == "__main__":
    ...
    #cv2.imwrite('output.png',img=(img_panorama).clip(0.0, 255.0).astype(np.uint8) )
